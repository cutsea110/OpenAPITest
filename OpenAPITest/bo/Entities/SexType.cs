...
namespace OpenAPITest.Domain
{
	...
	/// 性別区分条件
	/// </summary>
	public partial class SexTypeCondition
	{
		#region properties
		// [DataMember]
		...
		/// </summary>
		/// <returns></returns>
		public override Expression<Func<SexType, bool>> CreatePredicate()
		{
	...
	static public partial class SexTypeExtension
	{
		...
		/// <returns></returns>
		// static public IQueryable<SexType> TheMethod(this ITable<SexType> list)
		// {
