...
namespace OpenAPITest.Domain
{
	...
	/// 教員条件
	/// </summary>
	public partial class TeacherCondition
	{
		#region properties
		// [DataMember]
		...
		/// </summary>
		/// <returns></returns>
		public override Expression<Func<Teacher, bool>> CreatePredicate()
		{
	...
	static public partial class TeacherExtension
	{
		...
		/// <returns></returns>
		// static public IQueryable<Teacher> TheMethod(this ITable<Teacher> list)
		// {
